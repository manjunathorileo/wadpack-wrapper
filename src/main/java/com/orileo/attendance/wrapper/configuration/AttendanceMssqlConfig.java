package com.orileo.attendance.wrapper.configuration;
...
@EnableJpaRepositories(
        ...
        basePackages = {
                "com.orileo.attendance.wrapper.repository.mssqlrepository"
        }
)
    ...
    barEntityManagerFactory(
        ...
        return
                builder
                        ...
                        .packages("com.orileo.attendance.wrapper.entity.mssql")
